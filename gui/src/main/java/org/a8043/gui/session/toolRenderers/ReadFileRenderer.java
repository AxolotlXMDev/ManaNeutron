...
public class ReadFileRenderer implements ToolCallRenderer {
        @Override
        public Node render(JSONObject args) {
                return new Label(I18n.get("session.tools.read_file", args.getString("filePath"))) {{
                        getStyleClass().add("read-file-tool");
                }};
        }
