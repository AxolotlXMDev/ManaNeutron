...
public class NewSessionModal {
        private final Consumer<Session> onCreate;
        @FXML
        ...
        private void initialize() {
                Settings settings = ServerDataGetter.getSettings();
                SessionInfo last = ServerDataGetter.getLastSessionInfo();
                modelBox.getItems().addAll(ServerDataGetter.getModels());
        ...
        private void create() {
                ...
                Session session = Main.instance.getCurrentClient().newSession(name, workDir,
